...
ax.axvline(datetime.date(2021, 9, 4), ymin=0, ymax=1, color='red', linestyle='dashed')
ax.annotate('Added uploaders data', xy=(datetime.date(2021, 9, 4), 300), xytext=(datetime.date(2021, 8, 31), 200), arrowprops=dict(facecolor='red'), xycoords='data', color='red')
